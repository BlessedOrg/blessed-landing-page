      ...
      <div className="flex gap-8">
        <div className="w-[624px] h-[583px] p-0 pb-8 gap-8 rounded-[24px] overflow-hidden">
          ...
          <div className="p-6">
            ...
            <p className="text-xl font-bold">
              Learn about our latest security enhancements to protect your
              tickets.
            </p>
            <p>August 20, 2024</p>
          </div>
        ...
        <div className="w-[624px] h-[583px] p-0 pb-8 gap-8 rounded-[24px] overflow-hidden">
          ...
          <div className="p-6">
            <p>Update</p>
            <p className="text-xl font-bold">
              Explore our new tools designed for easy integration with existing
              systems.
            </p>
            <p>July 14, 2024</p>
          </div>
