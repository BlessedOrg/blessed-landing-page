...
export const LatestNewsCard = () => {
  return (
    <div className="flex flex-col md:flex-row gap-[24px]">
      <div
        className="flex flex-col h-[279px] w-full max-w-[39rem] p-[24px] justify-center items-center gap-[8px] self-stretch
      ...
      >
        ...
        <div className="text-xl font-regular">
          We’re listening. Tell us what you need to improve your experience.
        </div>
