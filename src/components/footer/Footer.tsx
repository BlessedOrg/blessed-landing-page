          ...
          <div className="flex flex-col sm:flex-row items-start gap-8 sm:gap-16 lg:gap-64 w-full">
            ...
            <div className="flex flex-col sm:flex-row gap-8 sm:gap-16 lg:gap-40">
              <div className="flex flex-col gap-4">
                ...
                <span><Link href="https://docs.blessed.fan/">Developer API</Link></span>
                <span><Link href="https://docs.blessed.fan/">Docs</Link></span>
                <span><Link href="/pricing">Pricing</Link></span>
              </div>
             
              <div className="flex flex-col gap-4">
                <span className="font-bold">Company</span>
                <span><Link href="/about_us">About us</Link></span>
                <span><Link href="/contact_us">Contact</Link></span>
                <span><Link href="/terms&conditions">Terms & conditions</Link></span>
                <span><Link href="/privacy_policy">Privacy policy</Link></span>
              </div>
            </div>
          </div>
              ...
              return (
                <a key={icon} href={urls[index]} target="_blank" rel="noopener noreferrer">
                  <div className="flex w-8 h-8 sm:w-[36px] sm:h-[36px] p-2 sm:p-[9px] items-start gap-[10px] bg-white rounded-full">
                    <img src={`/img/icons/${icon}.svg`} alt={icon} className="w-full h-full" />
                  </div>
                </a>
              )
            })}
