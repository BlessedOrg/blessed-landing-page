    ...
    <div className="relative w-full bg-gradient-to-r my-5 from-[#FFFACD] to-[#EFEFEF] py-[80px] px-4 flex flex-col items-center gap-8">
      <div className="relative flex w-[1280px] gap-[109px]">
        <div className="flex flex-col justify-center items-start w-[547px] h-auto z-10">
          ...
          <p className="mt-4">
            ...
            denied a ticket to a major concert, Viet had had enough. The system
            was broken, and it wasn’t just a one-off. Every event that fans care
            about is plagued by the same frustrating process. Something had to
            change.
          </p>
        </div>
      ...
      <div className="relative flex w-[1280px] gap-[109px]">
        ...
        <div className="relative flex flex-col justify-center items-start w-[547px] h-auto z-10">
          ...
          <p className="mt-4">
            After months of research, the conclusion was obvious—build it
            yourself. With verifiability, transparency, and fairness as the
            foundation, Blessed set out to change ticketing for good.
          </p>
        </div>
        {rightBars}
      </div>
      ...
      <div className="relative flex w-[1280px] gap-[109px]">
        <div className="flex flex-col justify-center items-start w-[547px] h-auto z-10">
          ...
          <p className="mt-4">
            ...
            around this idea. With one mission: Build to win. Build to last.
            Build the change we want to see. Build to value the outcomes. We
            strive to win and prove to the market that this is the last product
