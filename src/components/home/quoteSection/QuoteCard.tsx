...
export const QuoteCard = () => {
  return (
    <div className="flex flex-col md:flex-row gap-[24px] pb-20">
      ...
      <div className="flex flex-col h-[279px] w-[624.5px] p-[24px] justify-center items-center gap-4 self-stretch
      ...
      >
        ...
        <div className="text-xl font-regular">
          Join us on <Link href="https://t.me/blessedsupport" target="_blank" className="underline">Telegram</Link> or connect with our team via contact.
        </div>
